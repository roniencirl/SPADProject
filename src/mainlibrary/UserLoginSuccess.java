...
public class UserLoginSuccess extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        final Logger LOGGER = Logger.getLogger(UserLoginSuccess.class.getName());
        ...
        try {
            ...
            ps = Con.prepareStatement("select RegDate, Email, UserID from Users where UserName=?");
            ps.setString(1, User);
            ResultSet rs;
            rs = ps.executeQuery();
            ...
            LOGGER.log(Level.SEVERE, ("Exception validating user and password for UserLoginSuccess"));
        }
    }
